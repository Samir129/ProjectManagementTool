...
public class BacklogController {
    ...
    public ResponseEntity<?> updateProjectTask(@PathVariable String backlog_id,
                                               ...
                                               @Valid @RequestBody ProjectTask newTask,
                                               BindingResult result,
                                               Principal principal){
        ...
        ProjectTask projectTask = projectTaskService.updateProjectTaskbySequence(newTask, backlog_id, pt_id, principal.getName());
        return new ResponseEntity<>(projectTask, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> deleteProjectTask(@PathVariable String backlog_id, @PathVariable String pt_id, Principal principal){
        ...
        return new ResponseEntity<>("Project task with ID: '" + pt_id + "' was deleted", HttpStatus.OK);
    }
}
